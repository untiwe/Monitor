...
{
    /// <summary>
    /// Статический класс, благодаря которому можно получить имя монитора в системе
    ...
    public static class ScreenInterrogatory
    {
        ...
        public static string DeviceFriendlyName(this Screen screen)
        {
            ...
            for (var index = 0; index < Screen.AllScreens.ToArray().Length; index++)
            {

                if (Equals(screen, Screen.AllScreens.ToArray()[index]))
                {
